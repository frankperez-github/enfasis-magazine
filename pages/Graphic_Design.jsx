                    ...
                    <div className="Download">
                        <div className="Download_Card">
                            ...
                            <div className="Info-to-Download">
                                ...
                                <div className="ButtonsDownload">
                                    <button className="BlackButton">ver más</button><br/>
                                    <button className="BlackButton">descargar</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="Download_Card">
                            ...
                            <div className="Info-to-Download">
                                ...
                                <div className="ButtonsDownload">
                                    <button className="WhiteButton">ver más</button><br/>
                                    <button className="WhiteButton">descargar</button>
                                </div>
                            </div>
                        </div>
                    </div>    
