...
export default function PrivacyPoliceMob(){
    return(
        <div className="PrivacyPoliceMob">

            <GeneralMenu />

            <div className="contenedorMob">

                <div className="titularMob">
                    <div className="titular_izqMob">
                        <h1>POLÍTICA DE <br/>PRIVACIDAD</h1>
                    </div>
            
                    <div className="titular_derchMob">
